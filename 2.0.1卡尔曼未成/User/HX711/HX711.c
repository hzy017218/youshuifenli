...
void Get_Weight(void)
{
	...
	// {
		...
		Weight_Shiwu = (int32_t)((float)Weight_Shiwu/GapValue) + 0; 	//计算实物的实际重量
    ...
    //使用卡尔曼滤波器处理数据
    float filtered_weight = Kalman_Update(&kf, (float)Weight_Shiwu, 0.0f, dt);
